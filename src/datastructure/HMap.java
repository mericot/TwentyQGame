//---------------------------------------------------------------------------
// datastructure.HMap.java                by Dale/Joyce/Weems                     Chapter 8
//
...
public class HMap<K, V>  implements MapInterface<K,V>, Serializable
{
  ...
  {
    throw new UnsupportedOperationException("datastructure.HMap does not allow remove.");
  }    
  ...
  {
    return false;  // An datastructure.HMap is never full
  }
    ...
    { 
      if (!hasNext())
        throw new IndexOutOfBoundsException("illegal invocation of next " + 
                           " in datastructure.HMap iterator.\n");
      previousPos++;
